trigger DB_Custom_Daily_Record_Count_c on Daily_Record_Count__c ( before delete, after insert, after update, after undelete )
{
	try
	{
	...
	{
		CRMfusionDBR101.DB_TriggerHandler.handleTriggerException( ex, 'DB_Custom_Daily_Record_Count_c' );
	}
}