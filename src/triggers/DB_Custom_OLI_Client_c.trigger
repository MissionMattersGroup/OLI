trigger DB_Custom_OLI_Client_c on OLI_Client__c ( before delete, after insert, after update, after undelete )
{
	try
	{
	...
	{
		CRMfusionDBR101.DB_TriggerHandler.handleTriggerException( ex, 'DB_Custom_OLI_Client_c' );
	}
}