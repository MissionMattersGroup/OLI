trigger DB_Custom_Shelter_Call_c on Shelter_Call__c ( before delete, after insert, after update, after undelete )
{
	try
	{
	...
	{
		CRMfusionDBR101.DB_TriggerHandler.handleTriggerException( ex, 'DB_Custom_Shelter_Call_c' );
	}
}