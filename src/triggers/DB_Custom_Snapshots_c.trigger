trigger DB_Custom_Snapshots_c on Snapshots__c ( before delete, after insert, after update, after undelete )
{
	try
	{
	...
	{
		CRMfusionDBR101.DB_TriggerHandler.handleTriggerException( ex, 'DB_Custom_Snapshots_c' );
	}
}